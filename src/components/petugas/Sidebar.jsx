      ...
      <div className="px-6 py-8">
        ...
        {/* Menu Navigation */}
         ...
         { user.role === 'petugas' ? (
           ...
           <Link
             to="/petugas"
             className="block rounded-lg px-4 py-2 text-base hover:underline font-medium transition-all duration-200 ease-in-out"
           >
             Beranda
           </Link>
         </li>
         ...
         <li>
           <Link
               onClick={logoutHandler} // Update link ke halaman Logout atau login
             className="block rounded-lg px-4 py-2 text-base hover:underline font-medium transition-all duration-200 ease-in-out"
           >
             Logout
           </Link>
